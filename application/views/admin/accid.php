...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
           ...
           <!--  <li class="active"><a href="<?php echo base_url();?>index.php/admin/Advertise/advertising"><i class="fa fa-edit"></i> 广告管理</a></li> -->
            <li class="dropdown">
          ...
          <div class="col-lg-12">
            ...
            <div class="form-group">
                <form class="form-inline">
                  <div class="form-group">
                    <label for="adStatus" class="control-label">状态</label>
                  ...
                  <div class="form-group">
                    <label for="sponsor" class="control-label">赞助商名称</label>
                  ...
                  <!-- <div class="form-group">
                    <label for="adurl" class="control-label">广告URL</label>
                    <input type="text" class="form-control" id="adurl">
                  </div> -->
    ...
    <script src="<?php echo base_url();?>public/admin/js/accid.js"></script>
  </body>
</html>