...
<html lang="en">
  ...
  <body>
        ...
        <ul class="nav navbar-nav navbar-right navbar-user">
      	...
      	<div id="page-wrapper">
	        <div class="row">
	          <div class="col-lg-12">
	            <ol class="breadcrumb">
	              <li><a href="<?php echo base_url();?>index.php/admin/Bench/bench"><i class="fa fa-dashboard"></i>广告管理</a></li>
	              <li class="active"><i class="fa fa-table"></i>广告详情</li>
	            </ol>
	            <!--搜索区域开始--> 
    ...
    <script src="<?php echo base_url();?>public/admin/js/adDetail.js"></script>
  </body>
</html>