...
<html lang="en">
  ...
  <body>
          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="listContent">
                    <li class="active"><a href="<?php echo base_url();?>index.php/admin/Report/adCtatistics">广告统计</a></li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="fa fa-table"></i>广告统计</li>
            </ol>
            <!--搜索区域开始--> 
            <div class="form-group">
                <form class="form-inline">
                    ...
                    <div class="form-group">
                        <label for="city" class="control-label">播放市级</label>                    
                    ...
                    <div class="form-group">
                        <label for="advertiseTitle" class="control-label">广告标题</label>
                        <input type="text" class="form-control" id="advertiseTitle" value="" placeholder="模糊搜索">
                    </div>
                    <div class="form-group">
                        <label for="adShape" class="control-label">广告形式</label>                    
                        <select name="adShape" id="adShape" class="form-control">
    ...
    <script src="<?php echo base_url();?>public/admin/js/adCtatistics.js"></script>
  </body>
</html> 