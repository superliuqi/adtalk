...
<body>
	...
	<div class="row wrap">	
							...
							<div class="accordion-group"> 
								...
								<div id="accordion-element-28350" class="accordion-body in collapse">
									<div class="accordion-inner current">
										<a href="<?php echo base_url();?>index.php/Advertise/newAdvertise">新建广告</a>
									</div>
									<div class="accordion-inner">
                    <a href="<?php echo base_url();?>index.php/Advertise/newAccid">新建意外险广告</a>
                  </div>
									<div class="accordion-inner">
		...
		<form class="form-horizontal col-sm-10" id="advertiseForm" role="form" method="post" enctype="multipart/form-data">
			...
			<!-- 广告形式开始 -->
			<div class="form-group">
				<label for="cocNumber" class="col-sm-2 control-label"><span>* </span>广告形式</label>
				<div class="col-sm-4 weekday">
					<input type="radio" name="types" checked id="headAdvert" value="1" data-value="">
					<label for="headAdvert">冠名广告</label>
					<input type="radio" name="types" id="tailedAdvert" value="2" data-value="">
					<label for="tailedAdvert">尾标广告</label>
				</div>
			</div>
			<!-- 广告形式结束 -->
        ...
        <!-- 模态框结束 -->
			...
			<!-- <div class="form-group">
				...
				<div class="col-sm-4">
					<strong id="min">0.00</strong>条
				</div>
			</div> -->
			<!-- 剩余库存结束-->
			
			<!--- 尾标广告需填写的信息开始 -->
			<div class="tailedAdvert"> 
				<!-- 上传语音开始 -->          
				...
				<div class="form-group">
					...
					<textarea name="audioContent" id="audioContent" cols="30" rows="10" class="col-sm-5" placeholder="请完整的输入语音的内容" maxlength="400"></textarea>
				</div>
				<!-- 语音内容结束 -->
			</div>
			<!--- 尾标广告需填写的信息结束 -->
			...
			<div class="headAdvert">
             ...
             <p>支持jpg、jpeg、png格式的文件，大小不能超过5M</p>
	          <input type="file" id="logo" class="fileSelect" accept="image/*"/>
	          <input type="hidden" id="logoURL" name="logo">
            <img id="logoImg" src="<?php echo base_url(); ?>public/images/nopic.jpg" data-toggle="modal" data-target="#clipping">
            <div id="preview-pane">
