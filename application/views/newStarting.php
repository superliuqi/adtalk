...
<body>
	...
	<div class="row wrap">	
		...
		<form class="form-horizontal col-sm-10" id="advertiseForm" role="form" method="post" enctype="multipart/form-data">
			...
			<div class="form-group ">
				...
				<div class="col-sm-4 weekday">
					<input type="radio" name="area" id="nationwide">
			...
			<div class="form-group dn">
				...
				<div class="col-sm-8 choose">你选择的地区有：
			...
			<div class="form-group">
				...
				<div class="col-sm-4 weekday">
					<input type="radio" name="genre" id="Unlimited" value="1">
        ...
        <!-- 模态框结束 -->
          ...
          <div class="preview-pane-1 preview-pane">
          	<div class="preview-container">
          		<img src="<?php echo base_url(); ?>public/images/nopic.jpg" class="target" alt=""/>
          	</div>
        	</div>
        	<div class="preview-pane-2 preview-pane">
        		<div class="circle">
          	<div class="preview-container">
          		<img src="<?php echo base_url(); ?>public/images/nopic.jpg" class="target" alt=""/>
          	</div>
            ...
            <div class="modal-header">
          	...
          	<div class="modal-body">
          		<div class="adPositionId">
          			<h4>以下蓝色框内为广告位</h4>
          			<div class="starting startOne adBackground">
                  <div>
                    <img src="<?php echo base_url(); ?>public/images/nopic.jpg" class="previewLogo">
                  </div>
                </div>
                <div class="starting startTwo adBackground">
                  <div>
                    <img src="<?php echo base_url(); ?>public/images/nopic.jpg" class="previewLogo">
                  </div>
                  <p class="startNme"></p>
                </div>
                <div class="starting startThree adBackground">
                  <div>
                    <img src="<?php echo base_url(); ?>public/images/nopic.jpg" class="previewLogo">
                  </div>
                </div>
        ...
        <!-- 模态框结束 -->
			...
			<!-- 上传文件开始 -->          
			<div class="form-group">
				<label for="trcNumber" class="col-sm-2 control-label"><span>* </span>上传文件</label>
				<div class="col-sm-4">
           <p>暂支持zip格式，大小不能超过2M</p>
          <input type="file" id="userfile" name="userfile" accept="aplication/zip" multiple>
          <label for="logo" class="documentError"></label>
          <input type="hidden" id="userfileURL" name="document">
          <p class="filename none"></p>
				</div>
				<div id="query_hint" class="col-sm-4 query_hint none">
		   		<img src="<?php echo base_url(); ?>public/images/01.gif" />正在上传，请稍等...
				</div>
			</div>
			<!-- 上传文件结束 -->
			...
			<!-- 广告链接地址开始 -->
      <div class="form-group">
        <label for="sponsorUrl" class="col-sm-2 control-label"><span>* </span>广告链接地址</label>
        <div class="col-sm-5 sponsorUrl">
          <input type="url" class="form-control" id="sponsorUrl" placeholder="URL" name="sponsorUrl" disabled>
        </div>
      </div>
      <!-- 广告链接地址结束 -->
  ...
  <input type="hidden" size="4" id="h" name="h" />
	...
	<script src="<?php echo base_url();?>public/js/newStarting.js"></script>
