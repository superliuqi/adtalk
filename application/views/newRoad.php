...
<body>
    ...
    <form class="form-horizontal col-sm-10" id="advertiseForm" role="form" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          ...
          <img id="kanbanImg" src="<?php echo base_url(); ?>public/images/nopic.jpg">
          <!-- <div class="preview-pane-3 preview-pane">
      ...
      <!-- 广告链接地址开始 -->
      <div class="form-group">
        <label for="sponsorUrl" class="col-sm-2 control-label">广告链接地址</label>
        <div class="col-sm-5 sponsorUrl">
          <input type="url" class="form-control" id="sponsorUrl" placeholder="请输入链接地址" name="sponsorUrl">
        </div>
      </div>
      <!-- 广告链接地址结束 -->
      ...
      <!-- 广告链接地址开始 -->
      <div class="form-group">
        <label for="selectVoice" class="col-sm-2 control-label">是否上传语音</label>
        <div class="col-sm-5">
        <select class="form-control col-sm-10" id="selectVoice">
      ...
      <!-- 上传语音开始 -->          
      <div class="form-group voice none">
  ...
  <script src="<?php echo base_url();?>public/js/newRoad.js"></script>
